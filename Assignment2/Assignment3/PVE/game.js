...
function roll_dice(min, max) {
  ...
  if(getPlayerTurn() === "Computer" && cheat_modeB && turnB === 1 ){ 
    result = 5;
    turnB++;
  }else if(getPlayerTurn() === "Computer" && cheat_modeB && turnB === 2){
    result = 4; 
    turnB++;
  } else if(getPlayerTurn() === "Computer" && cheat_modeB && turnB === 3){ 
    result= 4;
    turnB++;
  }
...
function changePlayerTurn() {
  if (player === "Player1" && current_roll != 6) {
    player = "Computer";
  } else if (player === "Computer" && current_roll != 6){
    player = "Player1";
  } 
