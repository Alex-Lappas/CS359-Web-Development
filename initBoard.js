var player = "Player"; // player1= red Computer=white
var nameA;
var nameB;
  ...
  if (getPlayerTurn() === "Player1") {
    if (positionA === positionB) {
      ...
      document.getElementById("position" + newPosition).innerHTML =
        ...
        newPosition +
        ".png'  height=70 width=70></div>";
  } else if (getPlayerTurn() === "Computer") {
    if (positionA === positionB) {
      document.getElementById("position" + newPosition).innerHTML =
        "<img  src='imagesBoth/" +
        newPosition +
...
//function to initialize infobox
function setInfoBox() {
  ...
  if (result === 1) {
    ...
    player="Computer";
    document.getElementById("player_turn").innerText = "Turn : Computer";
  }
  ...
  document.getElementById("python_effectB").innerText =
    "Python effect: Inactive for Computer";
...
function updateGUI(old1, old2) {
  ...
  if (getPlayerTurn() === "Computer" && peB) {
    document.getElementById("python_effectB").innerText =
      "Pyhton effect: Active for Computer";
  }
...
function namePrompt() {
  nameA = prompt("What is your name Player1?");
  nameB = prompt("What is your name Player2?");
  console.log(nameA);
  console.log(nameB);
  if (nameA === "tsitsipas") activate_cheatmode("Player1");

  if (nameB === "tsitsipas") activate_cheatmode("Computer");
}